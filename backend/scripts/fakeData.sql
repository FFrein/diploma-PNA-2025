...
INSERT INTO "Review" ("userId", "rating", "description", "isVisible")
VALUES
(3, 5, 'Отличный приют, всем рекомендую!', true),
(4, 4, 'Хорошие условия для животных', true),
(5, 5, 'Профессиональные сотрудники', true),
(6, 3, 'Все понравилось, но долго оформляли документы', true),
(7, 5, 'Забрали чудесного кота, спасибо!', true),
(8, 4, 'Чисто, аккуратно, животные ухоженные', true),
(9, 5, 'Помогли подобрать идеальную собаку для семьи', true),
(10, 2, 'Не понравилось отношение сотрудников', false),
(1, 5, 'Лучший приют в городе!', true),
(2, 4, 'Хороший сервис, но мало информации', true);
