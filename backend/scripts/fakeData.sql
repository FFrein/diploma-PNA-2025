...
"Vaccination", "VaccinationAnimal", "Review", "News", "Goods", "Transactions"
...
INSERT INTO "Vaccination" ("name", "description")
VALUES
('Комплексная', 'От бешенства, чумы и других заболеваний'),
('От бешенства', 'Обязательная ежегодная вакцинация'),
('От чумы', 'Для щенков и взрослых собак'),
('От лишая', 'Для кошек и собак'),
('От глистов', 'Профилактическая обработка'),
('От блох', 'Сезонная обработка'),
('От аллергии', 'Специальная вакцина'),
('От инфекций', 'Комплексная защита'),
('Для щенков', 'Первые прививки'),
('Для котят', 'Первые прививки');
...
INSERT INTO "Goods" ("type", "name", "price", "description")
VALUES
('food', 'Сухой корм для кошек', 1200, 'Премиум класса, 5кг'),
('food', 'Влажный корм для собак', 80, 'Порционные пакетики'),
('toilet', 'Наполнитель', 500, 'Древесный, 10л'),
('item', 'Ошейник', 300, 'Нейлоновый, регулируемый'),
('medicines', 'Витамины', 250, 'Для шерсти и кожи'),
('food', 'Лакомства для кошек', 150, 'С тунцом'),
('toilet', 'Лоток', 700, 'Закрытый, с фильтром'),
('item', 'Лежанка', 1200, 'Для собак средних пород'),
('medicines', 'Капли от блох', 350, 'Для кошек и котят'),
('food', 'Корм для щенков', 1800, 'Гипоаллергенный, 7кг');
